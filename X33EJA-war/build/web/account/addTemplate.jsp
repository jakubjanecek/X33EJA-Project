...
<f:view>
    ...
    <title><h:outputText value="#{l10n.add_template}" /> - <h:outputText value="#{l10n.banking}" /></title>

    <%@include file="menu.jsp" %>
    <div id="content">
        <div class="padding">
            <h2><h:outputText value="#{l10n.add_template}" /></h2>
            <h:form id="addTemplate">
                <h:panelGrid columns="3">
                    ...
                    <h:commandButton value="#{l10n.add}" id="addButton" action="#{TemplateManagedBean.addTemplate}" />
                </h:panelGrid>
            </h:form>
